...
| `.dream__collage`, `.dream__cell`                           | Two to five photographs as one picture cut into cells, edge to edge in its tile; the grid arrives inline from the template (D82)                                                      |
...
| `/seznam`                | Seznam. Every dream as a line, in his own order — dragged by its grip, or by typing over its number (D79) — counted above (D77), searched below (D49); a line swiped left shows its hearts, Sdílet and Smazat (D78, `ui/DreamRow.svelte`); ＋ opens a sheet of five fields (D44)                                                                                            |
...
| `/sen/[id]`              | One dream: the tile — a collage from two photographs up (D82) — the shelf of its photographs, the facts with „Naposledy upraveno“ (D77), the heart, Upravit and Smazat                                                                                                                                                                                                      |
...
it floats in, and which way the point runs under a finger (D81); a new rule gets a test before it gets
