<script lang="ts" module>
	...
	const PATHS = {
		...
		/** Stahování — a cloud with an arrow coming down out of it (Lucide). */
		'cloud-download':
		...
		/* ── a row of the Seznam (Lucide) ───────────────────────────────── */
		/** Smazat, behind a swipe (D78). */
		trash:
		...
		/** The grip a row is dragged by: six dots, which is what every phone draws (D79). */
